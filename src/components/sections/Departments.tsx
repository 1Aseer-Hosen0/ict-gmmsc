...
import { Code, Video, BrainCircuit, Gamepad2 } from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {departments.map((dept, index) => {
            const Icon = dept.icon; // Fix: Correctly reference icon component
            return (
              <motion.div
                key={index}
              ...
              >
                <Card className="h-full bg-card/50 backdrop-blur-sm border-border/50 hover:border-club-blue/50 transition-all duration-300 overflow-hidden">
                  <CardContent className="p-8 text-center">
                    ...
                    >
                      <Icon className='w-10 h-10 text-club-white' />
